...
var functions = function () {
  ...
  function keys(arg) {
    ...
    if (Array.isArray(arg)) {
      ...
      utils.keys(arg).forEach(function (key) {
  ...
  function spread(arg) {
    ...
    if (Array.isArray(arg)) {
      ...
      var _iterator = _createForOfIteratorHelper(utils.keys(arg)),
        _step;
      try {
  ...
  function merge(arg) {
    ...
    arg.forEach(function (obj) {
      var _iterator2 = _createForOfIteratorHelper(utils.keys(obj)),
        _step2;
      try {
  ...
  function _each() {
    _each = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(obj, func) {
      var result, _iterator3, _step3, key, func_args, val, _t;
      return _regenerator().w(function (_context0) {
        while (1) switch (_context0.p = _context0.n) {
          case 0:
            result = this.createSequence();
            _iterator3 = _createForOfIteratorHelper(utils.keys(obj));
            _context0.p = 1;
            _iterator3.s();
          case 2:
  ...
  function _sift() {
    _sift = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(arg, func) {
      var result, _iterator4, _step4, item, entry, func_args, res, _t2;
      return _regenerator().w(function (_context14) {
        while (1) switch (_context14.p = _context14.n) {
          case 0:
            result = Object.create(null);
            _iterator4 = _createForOfIteratorHelper(utils.keys(arg));
            _context14.p = 1;
            _iterator4.s();
          case 2:
...
var jsonata = function () {
  ...
  function createFrameFromTuple(environment, tuple) {
    ...
    var _iterator = _createForOfIteratorHelper(utils.keys(tuple)),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
  ...
  function _evaluateUnary() {
    _evaluateUnary = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(expr, input, environment) {
      var result, focus, generators, _iterator5, _step5, generator, _generator, item, value, _t9;
      return _regenerator().w(function (_context11) {
        while (1) switch (_context11.n) {
          case 0:
            focus = {
          ...
          case 7:
            ...
            _iterator5 = _createForOfIteratorHelper(generators);
            try {
              for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                generator = _step5.value;
  ...
  function _evaluateGroupExpression() {
    _evaluateGroupExpression = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(expr, input, environment) {
      var result, groups, reduce, focus, itemIndex, item, env, pairIndex, pair, key, entry, generators, _iterator6, _step6, generator, _yield$generator, _yield$generator2, value, _t15;
      return _regenerator().w(function (_context14) {
        while (1) switch (_context14.p = _context14.n) {
          case 0:
            result = Object.create(null);
          ...
          case 10:
            _context14.n = 11;
            return Promise.all(utils.keys(groups).map(/*#__PURE__*/function () {
          ...
          case 11:
            ...
            _iterator6 = _createForOfIteratorHelper(generators);
            _context14.p = 12;
            _iterator6.s();
          case 13:
  ...
  function reduceTupleStream(tupleStream, environment) {
    ...
    for (var ii = 1; ii < tupleStream.length; ii++) {
      var _iterator2 = _createForOfIteratorHelper(utils.keys(tupleStream[ii])),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var prop = _step2.value;
  ...
  function evaluateTransformExpression(expr, input, environment) {
    ...
    var transformer = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(obj) {
        var cloneFunction, result, matches, ii, match, update, updateType, _iterator3, _step3, prop, deletions, val, jj;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
            ...
            case 7:
              // merge the update
              _iterator3 = _createForOfIteratorHelper(utils.keys(update));
              try {
    ...
    return {
      evaluate: function () {
        var _evaluate3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(input, bindings, callback) {
          var err, exec_env, _iterator4, _step4, v, time, it, _t;
          return _regenerator().w(function (_context3) {
            while (1) switch (_context3.p = _context3.n) {
              case 0:
                ...
                throw err;
              case 1:
                exec_env = createFrame(environment); // add any variable bindings may have been passed in
                _iterator4 = _createForOfIteratorHelper(utils.keys(bindings));
                try {
...
var utils = function () {
   ...
   */
  function keys(arg) {
    return _typeof(arg) === 'object' && arg !== null ? Object.keys(arg) : [];
  }
  return {
    isNumeric: isNumeric,
